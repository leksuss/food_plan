    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, verbose_name='Название')),
                ('image', models.ImageField(blank=True, null=True, upload_to='menu_category_images', verbose_name='Картинка')),
                ('dish', models.ManyToManyField(related_name='menu_category', to='baseapp.dish', verbose_name='Блюда')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_paid', models.BooleanField(default=False, verbose_name='Подписка оплачена?')),
                ('payment_id', models.CharField(blank=True, max_length=250, null=True, verbose_name='Идентификатор платежного агента')),
                ('allergies', models.ManyToManyField(blank=True, related_name='allergy_subscriptions', to='baseapp.allergy', verbose_name='Аллергии')),
                ('meal_types', models.ManyToManyField(blank=True, related_name='subscriptions', to='baseapp.mealtype', verbose_name='Типы приемов пищи')),
                ('menu_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subscriptions', to='baseapp.menucategory', verbose_name='Категория меню')),
                ('today_dishes', models.ManyToManyField(blank=True, related_name='dish_subscriptions', to='baseapp.dish', verbose_name='Сегодняшние блюда подписки')),
